        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <h1 className="text-5xl sm:text-6xl font-black tracking-tight leading-[1.05] text-slate-900 dark:text-white">
              Build & Sell Your 
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-500">AI Services in Weeks</span>
            </h1>

            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-xl leading-relaxed">
              The ultimate blueprint to master AI development, automate workflows, and launch a profitable AI business
            </p>
